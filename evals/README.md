...
whether an agent remembers Strata, avoids unnecessary ceremony, respects EP
...
released skill when practical. Record the harness/model and Strata revision
...
| `07-implementation-decision-boundary.md` | Material implementation discovery returns to Strata |
